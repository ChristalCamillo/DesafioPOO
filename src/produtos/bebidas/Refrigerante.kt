...
class Refrigerante(override var nome: String = "Refrigerante", override var quantidade: Int = 0, override var valor: Int = VALOR_REFRI, override var codigo: Int = 0) : Produto(
